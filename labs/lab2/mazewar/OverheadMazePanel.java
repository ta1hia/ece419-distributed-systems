                ...
                if(cellVisible) {
                    ...
                    if(o != null) {
                        if(o instanceof Client) {
                            ...
                            double rotation = 0.0; 
                            if(orient.toString().equals("South"))  { //== Direction.South) {
                                rotation=-java.lang.Math.PI/2.0;
                            } else if (orient.toString().equals("North")) { //(orient == Direction.North) {
                                rotation=java.lang.Math.PI/2.0;
                            } else if (orient.toString().equals("West")) { // == Direction.West) {
